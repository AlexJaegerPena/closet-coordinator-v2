...
const [imageUpload, setImageUpload] = useState(null);
 ...
 const [form, setForm] = useState({category:"",type:"",color:"",season:"",occasion:"",img:"",energyLevel:""})
...
{/* Category */}
      <div>
        <label className="block text-sm font-medium text-red-700">Clothes Category</label>
        <select 
        name={"category"}
          value={form.category} 
          required
      ...
      <div className='border'>
        <label className="block text-sm font-medium text-green-700">Types</label>
        <select 
        value={form.occasion} 
        required
      ...
      <div className='border'>
        <label className="block text-sm font-medium text-blue-700">Occasions</label>
        <select 
        value={form.occasion} 
        name='occasion'
        required
