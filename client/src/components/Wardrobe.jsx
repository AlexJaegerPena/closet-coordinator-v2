    ...
    <div className="flex flex-col h-screen px-4 py-4">
      ...
      <div className="flex flex-col flex-grow">
        <div className="grid grid-cols-2 gap-4 w-full max-w-4xl mx-auto mb-4">
          <div className="relative w-full h-48 bg-gray-200 border rounded-3xl overflow-hidden">
            <img
        ...
        <div className="flex flex-col items-center justify-center">
          {showOptions ? (
            ...
            <button
              className="btn bg-gradient-to-r from-sky-600 to-teal-400 w-60 h-12 text-white text-lg rounded-3xl shadow-lg"
